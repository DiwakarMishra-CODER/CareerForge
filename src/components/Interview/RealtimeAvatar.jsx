                ...
                <svg viewBox="0 0 200 250" className="w-full h-full">
                    <defs>
                        <linearGradient id="skinGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                            ...
                            <stop offset="100%" stopColor={theme.skin} stopOpacity="0.8" />
                        </linearGradient>
                    </defs>

                    <ellipse cx="100" cy="280" rx="90" ry="60" fill={theme.shirt} />
                    <rect x="85" y="175" width="30" height="35" fill={theme.skin} rx="5" />
                    <path d="M70 200 L100 220 L130 200 L130 250 L70 250 Z" fill={theme.shirt} />
                    ...
                    <path d="M45 90 Q50 40 100 35 Q150 40 155 90 Q155 70 145 60 Q130 50 100 48 Q70 50 55 60 Q45 70 45 90 Z" fill={theme.hair} />

                    <path d={emotionStyles.eyebrowLeft} stroke={theme.hair} strokeWidth="3" fill="none" strokeLinecap="round" />
                    <path d={emotionStyles.eyebrowRight} stroke={theme.hair} strokeWidth="3" fill="none" strokeLinecap="round" />

                    <g>
                        <ellipse cx="75" cy={emotionStyles.eyesDroop ? 102 : 100} rx="12" ry={eyeBlink ? 1 : emotionStyles.eyesDroop ? 6 : 8} fill="white" />
                        <circle cx="75" cy={emotionStyles.eyesDroop ? 102 : 100} r={eyeBlink ? 0 : 5} fill={theme.eyes} />
                        <ellipse cx="125" cy={emotionStyles.eyesDroop ? 102 : 100} rx="12" ry={eyeBlink ? 1 : emotionStyles.eyesDroop ? 6 : 8} fill="white" />
                        <circle cx="125" cy={emotionStyles.eyesDroop ? 102 : 100} r={eyeBlink ? 0 : 5} fill={theme.eyes} />
                    </g>

                    <path d="M100 105 L95 125 Q100 130 105 125 L100 105" fill="none" stroke={theme.skin} strokeWidth="2" strokeOpacity="0.5" />

                    <path d={getMouthPath()} fill={isSpeaking ? "#8B0000" : (currentEmotion === 'happy' ? "#C4847B" : "none")} stroke="#C4A484" strokeWidth="2" />

                    <circle cx="60" cy="125" r="12" fill="#FFB6C1" opacity={emotionStyles.cheekBlush} />
                    <circle cx="140" cy="125" r="12" fill="#FFB6C1" opacity={emotionStyles.cheekBlush} />
                </svg>
